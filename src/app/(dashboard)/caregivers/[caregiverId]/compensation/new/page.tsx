...
interface CompensationNewPageProps {
  params: Promise<{
    caregiverId: string
  }>
}

export default async function CompensationNewPage({ params }: CompensationNewPageProps) {
  await requireAuth()
  ...
  return <CompensationForm caregiver={caregiver} orgId={orgId} />
}
